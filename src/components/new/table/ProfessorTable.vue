...
<script>
  ...
  import ProfessorCard from '../card/ProfessorCard'
  ...
  export default {
    ...
    props: {
      tableUrl: {
        type: String,
        default: '/zscq/portal/expertPage'
      }
    },
    data() {
      return {
    ...
    mounted() {
      const that = this
      bus.$on('changeParamProfessor', function(param) {
