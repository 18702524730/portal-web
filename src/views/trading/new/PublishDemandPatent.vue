        ...
        <a-card>
          ...
          <div class="my-modal">
            <a-form-model :model="form" :label-col="labelCol" :wrapper-col="wrapperCol" :rules="rules" ref="ruleForm">
              ...
              <a-form-model-item label="需求标题" prop="patentName">
                <a-input v-model="form.patentName" placeholder="请输入需求标题" id="patentName" :disabled="disabled"/>
              </a-form-model-item>
              ...
              <a-form-model-item label="交易方式" prop="intendedOperationMode" ref="intendedOperationMode">
                <j-dict-select-tag type="radio" dict-code="patent_transaction_type"
              ...
              <a-form-model-item label="技术领域" prop="technicalField" ref="technicalField">
                <j-dict-select-tag :disabled="disabled" type="list" v-model="form.technicalField"
                                   dictCode="technical_field" placeholder="请选择技术领域" id="technicalField"
                                   @input="changeTag('technicalField')"/>
              </a-form-model-item>

              <a-form-model-item label="合作区域" prop="cooperationArea" ref="cooperationArea">
                <j-dict-select-tag :disabled="disabled" type="radio" v-model="form.cooperationArea"
                                   dictCode="cooperation_area" placeholder="请选择合作区域"
                                   id="cooperationArea" @input="changeTag('cooperationArea')"></j-dict-select-tag>
              </a-form-model-item>
              ...
              <a-form-model-item label="研发背景" prop="devBackground">
                <a-textarea :disabled="disabled" v-model="form.devBackground" rows="4" placeholder="请输入研发背景"
                            id="devBackground"/>
              </a-form-model-item>
              <a-form-model-item label="攻关目标" prop="patentTarget">
                <a-textarea :disabled="disabled" v-model="form.patentTarget" rows="4"
                            placeholder="请输入攻关目标" id="patentTarget"/>
              </a-form-model-item>

              <a-form-model-item label="成果形式" prop="resultShow" ref="resultShow">
                <j-editor v-model="form.resultShow" id="resultShow" :disabled="disabled"
                          @input="changeTag('resultShow')"/>
              </a-form-model-item>

              <a-row class="main-h3 my-row my-other">
                <h3>专利需求描述</h3>
              </a-row>
              <a-form-model-item label="技术难题主要内容" prop="technicalProblemContent">
                <a-input v-model="form.technicalProblemContent" type="textarea" placeholder="请输入技术难题主要内容"
                         id="technicalProblemContent" rows="4" :disabled="disabled"/>
              </a-form-model-item>

              <a-form-model-item label="前期研究开发基础" prop="qqyjkfjc">
                <a-input v-model="form.qqyjkfjc" type="textarea" placeholder="请输入前期研究开发基础"
                         id="qqyjkfjc" rows="4" :disabled="disabled"/>
              </a-form-model-item>

              <a-form-model-item label="生产和研发设备" prop="schyfsb" ref="schyfsb">
                <j-editor v-model="form.schyfsb" id="schyfsb" :disabled="disabled" @input="changeTag('schyfsb')"/>
              </a-form-model-item>
    ...
    data() {
      ...
      return {
        ...
        rules: {
          ...
          devBackground: [{ required: true, max: 1000, message: '请输入研发背景，长度在1000字以内!' }],
          patentTarget: [{ required: true, max: 1000, message: '请输入攻关目标，长度在1000字以内!' }],
          resultShow: [{ required: true, message: '请输入成果形式!' }],
          ...
          technicalProblemContent: [{ required: true, max: 1000, message: '请输入技术难题主要内容，长度在1000字以内!' }],
          qqyjkfjc: [{ required: true, max: 1000, message: '请输入前期研究开发基础，长度在1000字以内!' }],
          schyfsb: [{ required: true, message: '请输入生产和研发设备!' }]
        },
        endOpen: false,
        url: {
          add: '/patent/portalRequirementPatent/add',
          auditAction: '/patent/portalRequirementPatent/auditAction',
          edit: '/patent/portalRequirementPatent/edit',
          projectUrl: '/patent/portalRequirementPatent/queryById',
          getUserInfo: '/sys/user/queryByUserName'
        },
        checkUrl: '/patent/portalRequirementPatent/patentInfoCheck',
        commitUrl: '',
        itemId: '',
