...
export const PROJECT_TRADING_TYPE = 'PROJECT_TRADING_TYPE'

export const SUPPLY_PROJECT = 'SUPPLY_PROJECT'
export const SUPPLY_PATENT = 'SUPPLY_PATENT'
export const SUPPLY_BRAND = 'SUPPLY_BRAND'
